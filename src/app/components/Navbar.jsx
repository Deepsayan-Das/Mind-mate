...
function Navbar() {
  ...
  return (
    <nav className={`fixed top-0 left-0 w-full bg-transparent z-10 text-white py-4 px-6  transition-transform duration-300 ${isVisible ? 'translate-y-0' : '-translate-y-full'}`}>
